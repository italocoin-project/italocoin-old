...
Core tests take longer than any other Italocoin tests, due to the high amount of computational work involved in validating core components.
...
To run only Italocoin's core tests (after building):
...
To run only Italocoin's crypto tests (after building):
...
To run only Italocoin's hash tests (after building):
...
To run only Italocoin's performance tests (after building):
...
To run only Italocoin's unit tests (after building):

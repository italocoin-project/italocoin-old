...
posted to #italocoin-dev on irc.freenode.net).
...
The "Italocoin Maintainer Team" is defined in this document as the following users:
- fluffypony
- italocoinmooo
- hyc
...
- Users SHALL NOT log feature requests, ideas, or suggestions unrelated to Italocoin code or Italocoin's dependency code or Italocoin's potential/future dependency code or research which successfully implements Italocoin.
...
- Maintainers SHOULD NOT merge their own patches except in exceptional cases, such as non-responsiveness from other Maintainers for an extended period (more than 30 days) or unless urgent as defined by the Italocoin Maintainers Team.
...
- Maintainers MUST NOT merge pull requests in less than 168 hours (1 week) unless deemed urgent by at least 2 people from the Italocoin Maintainer Team.

...
ENTRYPOINT ["italocoind", "--p2p-bind-ip=0.0.0.0", "--p2p-bind-port=13101", "--rpc-bind-ip=0.0.0.0", "--rpc-bind-port=13102", "--non-interactive", "--confirm-external-bind"]